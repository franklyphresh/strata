...
A **Collective** is a new approach for like-minded creators to monetize the efforts of group cooperation. A collective is a group of social tokens that have bonded their direction success to a base token. Collectives allow participants to pool resources with their network of social tokens. Collectives reorient directional goals towards the success of groups rather than individuals alone. 
