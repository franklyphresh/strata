...
export const SplTokenBondingIDLJson: Idl & { metadata?: { address: string } } = {
  ...
  "instructions": [
    ...
    {
      "name": "upgradeBaseStorageAuthority",
      "accounts": [
        {
          "name": "tokenBonding",
          "isMut": false,
